            ...
            <div className={styles.contentContainer}>
                ...
                <div className={styles.tablesContainer} ref={statsRef}>
                    <div className={styles.tablesTitle}>
                        ...
                        Каждый день команда профессиональных журналистов пишет о
                        событиях в политике, экономике, спорте и других сферах
                        жизни. Редакция стремится быть надежным и достоверным
